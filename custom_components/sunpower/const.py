...
DEFAULT_NIGHTTIME_UPDATE_INTERVAL = 0  # Disabled by default
MIN_SUNPOWER_UPDATE_INTERVAL = 60
MIN_SUNVAULT_UPDATE_INTERVAL = 20
MIN_NIGHTTIME_UPDATE_INTERVAL = 300  # 5 minutes minimum for nighttime
SUNPOWER_UPDATE_INTERVAL = "PVS_UPDATE_INTERVAL"
SUNVAULT_UPDATE_INTERVAL = "ESS_UPDATE_INTERVAL"
NIGHTTIME_UPDATE_INTERVAL = "NIGHTTIME_UPDATE_INTERVAL"
SETUP_TIMEOUT_MIN = 5

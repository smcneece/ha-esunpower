...
SUNPOWER_SENSORS = {
    PVS_DEVICE_TYPE: {
        ...
        "sensors": {
            ...
            "PVS_RAM_USAGE_PERCENT": {
                "field": "ram_usage_percent",
                "title": "{SUN_POWER}{MODEL} {SERIAL} RAM Usage",
                "unit": PERCENTAGE,
                "icon": "mdi:memory",
                "device": None,
                "state": SensorStateClass.MEASUREMENT,
            ...
            "PVS_FLASH_USAGE_PERCENT": {
                "field": "flash_usage_percent",
                "title": "{SUN_POWER}{MODEL} {SERIAL} Flash Usage",
                "unit": PERCENTAGE,
                "icon": "mdi:harddisk",
                "device": None,
                "state": SensorStateClass.MEASUREMENT,
            ...
            "PVS_FLASH_WEAR": {
                "field": "flashwear_percent",
                "title": "{SUN_POWER}{MODEL} {SERIAL} Flash Wear",
                "unit": PERCENTAGE,
                "icon": "mdi:chip",
                "device": None,
                "state": SensorStateClass.MEASUREMENT,
    ...
    ESS_DEVICE_TYPE: {
        ...
        "sensors": {
            "ESS_STATE_OF_CHARGE": {
                "field": "soc_val",
                "title": "{SUN_POWER}{MODEL} {SERIAL} State of Charge",
                "unit": PERCENTAGE,
            ...
            "ESS_STATE_OF_HEALTH": {
                "field": "soh_val",
                "title": "{SUN_POWER}{MODEL} {SERIAL} State of Health",
                "unit": PERCENTAGE,
            ...
            "ESS_POWER": {
                "field": "power_3ph_kw",
                "title": "{SUN_POWER}{MODEL} {SERIAL} Power",
                "unit": UnitOfPower.KILO_WATT,
                "icon": "mdi:flash",
                "device": SensorDeviceClass.POWER,
                "state": SensorStateClass.MEASUREMENT,
            ...
            "ESS_OPERATING_MODE": {
                "field": "op_mode",
                "title": "{SUN_POWER}{MODEL} {SERIAL} Operating Mode",
                "unit": None,
            ...
            "ESS_BATTERY_VOLTAGE": {
                "field": "v_batt_v",
                "title": "{SUN_POWER}{MODEL} {SERIAL} Battery Voltage",
                "unit": UnitOfElectricPotential.VOLT,
            ...
            "ESS_INVERTER_TEMP": {
                "field": "t_invtr_degc",
                "title": "{SUN_POWER}{MODEL} {SERIAL} Inverter Temperature",
            ...
            "ESS_MAX_CELL_TEMP": {
                ...
                "title": "{SUN_POWER}{MODEL} {SERIAL} Max Cell Temperature",
                "unit": UnitOfTemperature.CELSIUS,
            ...
            "ESS_MIN_CELL_TEMP": {
                ...
                "title": "{SUN_POWER}{MODEL} {SERIAL} Min Cell Temperature",
                "unit": UnitOfTemperature.CELSIUS,
            ...
            "ESS_CHARGE_LIMIT": {
                ...
                "title": "{SUN_POWER}{MODEL} {SERIAL} Max Charge Power",
                "unit": UnitOfPower.KILO_WATT,
            ...
            "ESS_DISCHARGE_LIMIT": {
                ...
                "title": "{SUN_POWER}{MODEL} {SERIAL} Max Discharge Power",
                "unit": UnitOfPower.KILO_WATT,

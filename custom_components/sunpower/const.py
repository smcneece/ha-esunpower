...
# Live data sensor definitions (new firmware only, under virtual "PVS Live Data" device)
# battery_only=True: only created when battery system detected
# enabled_default=False: entity disabled in registry by default
LIVEDATA_SENSORS = [
    {
    ...
    {
        "key": "site_load_energy",
        "var_name": "/sys/livedata/site_load_en",
        "title": "Site Load Energy",
        "unit": UnitOfEnergy.KILO_WATT_HOUR,
        "icon": "mdi:home-lightning-bolt",
        "device_class": SensorDeviceClass.ENERGY,
        "state_class": None,
    ...
    },
    {
        ...
        "suggested_display_precision": None,
        "battery_only": False,
        "enabled_default": False,  # Changes every second; disable by default to avoid database bloat
        "entity_category": EntityCategory.DIAGNOSTIC,
    },
]
